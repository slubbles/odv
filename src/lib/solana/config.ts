...
// SOON Testnet Configuration (Deployed December 10, 2025 - with campaign_id support)
export const PROGRAM_ID = new PublicKey('2NZKEk8zk47UAc27f7DScFgxpqyy22VptWVwBUjFfQxC');
