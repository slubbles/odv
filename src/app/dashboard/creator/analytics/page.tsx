    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 flex-1 pb-24 md:pb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
          <div>
            <h1 className="font-sans text-3xl sm:text-4xl font-semibold mb-2 text-balance">The Numbers</h1>
        ...
        <div className="grid gap-4 sm:gap-6 grid-cols-2 md:grid-cols-4 mb-6 sm:mb-8">
          <Card className="p-4 sm:p-6">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs sm:text-sm text-muted-foreground">Money In</p>
              <DollarSign className="h-4 w-4 text-accent" />
            </div>
            <p className="text-2xl sm:text-3xl font-semibold">$24,567</p>
            <p className="text-[10px] sm:text-xs text-green-400 mt-1">+12.5% from last month</p>
          </Card>

          <Card className="p-4 sm:p-6">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs sm:text-sm text-muted-foreground">Believers</p>
              <Users className="h-4 w-4 text-accent" />
            </div>
            <p className="text-2xl sm:text-3xl font-semibold">1,234</p>
